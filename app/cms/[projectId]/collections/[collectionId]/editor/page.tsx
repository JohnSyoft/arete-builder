...
function CollectionEditorContent({
  ...
  return (
    <>
      {/* Custom toolbar for collection editor */}
      <div className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-lg font-semibold text-gray-900">
            Edit Collection: {collection?.name || "Untitled Collection"}
          </h1>
        </div>
            ...
            >
              <Frame data={layoutData}>
                <Element
                  ...
                  data-testid="collection-canvas-root"
                >
...
export default function CollectionEditorPage() {
  ...
  const currentResolver = useMemo(() => {
    ...
    // Filter out page-level components for collection editor
  ...
  const currentCollection = collections.find((c: any) => c._id === collectionId);
  
  const isLoading = projectLoading || collectionsLoading;
  const error = projectError || collectionsError;

  const handleSave = async (layout: any) => {
    console.log("Collection layout saved:", layout);
    // TODO: Implement actual save logic for collection layout
  };
  ...
  const layoutData = useMemo(() => {
    // For now, return a default empty layout
    // TODO: Load actual collection layout from API
    return {
      ROOT: {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading collection editor...</p>
        </div>
      </div>
    );
  }

  if (!project || !currentCollection) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">
            The project or collection you're looking for doesn't exist.
          </p>
