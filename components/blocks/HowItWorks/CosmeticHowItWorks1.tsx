...
export interface CosmeticHowItWorks1Props extends SectionProps {
  sectionTag?: string;
  mainTitle?: string;
  description?: string;
  buttonText?: string;
...
export const CosmeticHowItWorks1 = ({
  ...
  return (
    ...
    >
      <Section {...sectionProps}>
        <Element
          id="cosmeticHowItWorksContainer"
          is={Box}
                    ...
                    >
                      <div className="group text-center">
                        ...
                        <div className="mb-6 flex justify-center">
                          <div
                            className={`w-16 h-16 flex items-center justify-center text-[${accentColor}]`}
...
CosmeticHowItWorks1.craft = {
  displayName: "Cosmetic How It Works 1",
  props: {
    sectionTag: "HOW IT WORK",
    mainTitle: "Simple steps to stunning transformations",
    description:
