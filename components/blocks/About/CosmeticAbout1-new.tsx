...
export const CosmeticAbout1 = ({
  ...
  mainImage = "https://images.unsplash.com/photo-1629909613654-28e377c37b09?w=400&h=600&fit=crop&crop=face",
  secondaryImage = "https://images.unsplash.com/photo-1616391182219-e080b4d1043a?w=300&h=400&fit=crop&crop=face",
  experienceImage = "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=200&h=200&fit=crop&crop=face",
            ...
            >
              ...
              >
                <div className="relative w-full">
                  {/* Star decoration - Absolute positioned */}
                  ...
                  {/* Experience Badge - Absolutely positioned over images */}
                  <div className="absolute bottom-8 right-8 w-32 h-32 z-20">
                    <div className="w-full h-full relative">
                      {/* Circular Text Path Background */}
                      <div className="absolute inset-0 flex items-center justify-center">
                        <svg className="w-full h-full animate-spin-slow" style={{ animationDuration: '20s' }} viewBox="0 0 250 250">
                          <defs>
                            <path id="circle-path" d="M 125, 125 m -100, 0 a 100,100 0 1,1 200,0 a 100,100 0 1,1 -200,0" />
                          </defs>
                          <text className="text-xs" fill={accentColor} fontSize="14">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-lg">
                          <svg viewBox="0 0 24 24" fill={accentColor} className="w-8 h-8">
                            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                          </svg>
                        </div>
                      </div>
