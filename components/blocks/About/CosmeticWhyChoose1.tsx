...
export interface CosmeticWhyChoose1Props extends SectionProps {
  sectionTag?: string;
  mainTitle?: string;
  description?: string;
...
export const CosmeticWhyChoose1 = ({
