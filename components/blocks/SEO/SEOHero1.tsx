          ...
          <div className="text-gray-900">
            <div className="mb-6">
              <h1 className="text-6xl lg:text-8xl xl:text-9xl font-light leading-tight mb-4 tracking-tight">
                ...
                <span className="block font-bold text-7xl lg:text-8xl xl:text-9xl bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                  search results
                </span>
              </h1>
            </div>
            ...
            <Button
              size="lg"
              className="bg-gradient-to-r from-orange-500 to-sky-500 hover:from-orange-600 hover:to-sky-600 text-white px-8 py-4 text-lg font-semibold rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
            >
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -right-8 bg-white rounded-lg shadow-2xl p-4 transform rotate-3 hover:rotate-0 transition-transform duration-300">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-semibold text-gray-900">+127% Traffic</div>
