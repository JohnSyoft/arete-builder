      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            id="cols"
            type="number"
            value={elementProps?.cols || 50}
            onChange={(e) => onPropChange("cols", parseInt(e.target.value) || 50)}
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="e.g., 100px, 10rem, h-32"
          />
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => onPropChange("maxLength", parseInt(e.target.value) || undefined)}
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => onPropChange("minLength", parseInt(e.target.value) || undefined)}
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="ID of element that describes this textarea"
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="e.g., textbox, combobox"
          />
        </div>
