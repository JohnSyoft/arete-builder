...
export function CheckboxGroupProperties({ elementProps, onPropChange }: CheckboxGroupPropertiesProps) {
  ...
  const addOption = () => {
    const newOptions = [...(elementProps?.options || []), { label: 'New Option', value: 'new-option', checked: false }]
    onPropChange('options', newOptions)
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-sm font-medium text-gray-900 mb-4">Checkbox Group Settings</h3>
              ...
              <div>
                <label className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={(e) => handleOptionChange(index, 'checked', e.target.checked)}
                    className="rounded"
                  />
