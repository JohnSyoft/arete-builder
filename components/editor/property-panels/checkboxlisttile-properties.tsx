...
interface CheckboxListTilePropertiesProps {
  elementProps: any
  onPropChange: (key: string, value: any) => void
}

export function CheckboxListTileProperties({ elementProps, onPropChange }: CheckboxListTilePropertiesProps) {
  ...
  const addItem = () => {
    const newItems = [...(elementProps?.items || []), { title: 'New Item', subtitle: '', value: 'new-item' }]
    onPropChange('items', newItems)
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-sm font-medium text-gray-900 mb-4">Checkbox List Settings</h3>
